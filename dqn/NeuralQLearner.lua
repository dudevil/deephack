...
function nql:__init(args)
    ...
    self.input_dims     = args.input_dims or {self.hist_len*self.ncols, 63, 63}
...
function nql:qLearnMinibatch()
    ...
    local indexi, s, a, r, s2, term = self.transitions:sample(self.minibatch_size)
...
function nql:sample_validation_data()
    local index, s, a, r, s2, term = self.transitions:sample(self.valid_size)
